...
public class TestingConstants {
    ...
    public static final String VALID_URL_TO_TEST_WIKIPEDIA = "https://www.wikipedia.com/";
    ...
    public static URL validTestUrlWikipedia;
    ...
    static {
        try {
            ...
            validTestUrlWikipedia = new URL(VALID_URL_TO_TEST_WIKIPEDIA);
